...
export default function HomeSuggestedHomeTop() {
    ...
    useEffect(() => {
      const fetchProducts = async () => {
        try {
          const response = await axios.get(`http://localhost:8000/api/v1/products/top-by-sold?per_page=8`);
        ...
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 xl:gap-x-8">
                ...
                <a onClick={handleProductQuickView} key={product.id} href={product.href} className="group">
                    ...
                    <h3 className="mt-4 text-lg font-medium text-gray-900 whitespace-nowrap overflow-hidden overflow-ellipsis">{product.name}</h3>
