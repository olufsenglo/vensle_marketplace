      ...
      {errorMessage && <p className="text-red-500 mb-8">{errorMessage}</p>}
	    ...
	    <form className="flex flex-col space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        name="name"
                        className={`mt-1 block w-full rounded ring-1 ring-gray-300 border-gray-300 bg-gray-50 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-blue-500 ${
                          errors.name
                            ? "bg-red-50"
                            : "bg-gray-50"
				}`}
	   ...
	   {isAuthenticated ?
            <button
              ...
              className={`mt-6 w-full rounded-md bg-red-500 py-3 px-6 font-medium text-white hover:bg-red-600 ${
		      !hasItems && "cursor-not-allowed"
	      }`}
            >
