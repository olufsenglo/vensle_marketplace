                        ...
                        <div style={{ "display": "flex", "align-items": "center", "font-size": "0.9rem", "margin-left":"38px"}}>
                            <div className="flex" style={{ "align-items": "center" }}>
                                ...
                                <div style={{ "display": "flex", "justify-content": "space-between", "flex-direction": "column", "height": "100%" }}>
                                    <p style={{"fontSize":"12px", "marginTop": "0px", "marginBottom":"3px"}}>Hello Guest</p>
                            ...
                            <div className="flex" style={{ "align-items": "center" ,"margin-left":"41px"}}>
                                <img src={cart} style={{"marginTop":"0px"}}/>
                                <div style={{ "display": "flex", "justify-content": "space-between", "flex-direction": "column", "height": "100%", "marginLeft":"1px"}}>
                                    <p style={{"font-size":"12px", "cursor":"default", "marginTop":"0px", "fontWeight":"bold"}} onClick={() => setOpen(true)}>Your cart</p>
                                    <h2 style={{"color":"#ff5959", "text-align":"right", "fontSize":"14px", "marginTop": "0px", "fontWeight":"500"}}>$0.00</h2>
                                </div>
                            </div>
                        </div>
                    </div>
