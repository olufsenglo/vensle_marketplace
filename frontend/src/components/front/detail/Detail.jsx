  ...
  const handleShowSelectedImage = (productImage, index) => {
    ...
    return (
      <a
        ...
        href="#"
        className={`dark:border-transparent block overflow-hidden rounded-lg border-2 hover:border-red-300 dark:hover:border-blue-300 ${
            ...
            <div className="bg-white lg:col-span-3 lg:pr-8">
              ...
              <div class="mt-10 w-full">
                <div class="sticky top-0 overflow-hidden ">
                  <div class="relative mb-6 px-10 lg:mb-10 lg:h-[28rem]">
                    <span
                    ...
                    <img
                      ...
                      className="w-full object-cover px-6 lg:h-full"
                    />
                    <span
		...
		{`${product.currency} ${product.price}`}
              ...
              {product && product.type == "grocery" && (
                <button
                  ...
                  className="bg-transparent hover:border-transparent mt-4 w-full rounded border border-orange-500 py-3 px-2 font-semibold text-orange-500 hover:bg-orange-500 hover:text-white"
                >
                  ADD TO CART
                </button>
              )}
