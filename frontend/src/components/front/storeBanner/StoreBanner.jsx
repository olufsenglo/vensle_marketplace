  ...
  return (
	...
	<svg className="h-10 w-10 mr-1 text-gray-600"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
	  ...
	  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
			...
			<div>
				<h2 className="text-lg md:text-2xl font-normal tracking-tight text-gray-900 uppercase">official</h2>
				<h2 className="text-lg md:text-2xl font-normal tracking-tight text-gray-900 uppercase">store</h2>
			</div>

		      </div>
		      <h1 className="mt-5 text-sm md:text-lg font-bold tracking-tight text-gray-900 sm:text-xl">All things groceries</h1>
		  </div>
	  </div>
	...
	<svg className="h-10 w-10 mr-1 text-gray-600"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
	  ...
	  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
			...
			<div>
		      ...
		      <h1 className="mt-5 text-sm md:text-lg font-bold tracking-tight text-gray-900 sm:text-xl">All things fashion</h1>
		  </div>
	  </div>
