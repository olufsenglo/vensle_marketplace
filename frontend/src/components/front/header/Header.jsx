    ...
    if (!resetToken) {
      ...
      try {
        ...
        dispatch({
          type: "SET_MESSAGE",
          payload:
            "Password reset successfull you can now login with your new password",
        });
      } catch (error) {
        if (error.response) {
          if (error.response.data.error) {
                        ...
                        {activeTab === 3 && (
                          <form onSubmit={handleResetPassword}>
                            <div className="mb-4 flex justify-center">
                              <h3 className="inline border-b-2 border-orange-500 py-2 px-4 pb-1 text-center">
                                FORGOT PASSWORD
                              </h3>
                            </div>
                            <div className="mt-4">
                            ...
                            <div className="mb-6 flex">
                              <div
                                className={`w-full cursor-pointer py-2 px-4 text-center ${
                                  activeTab === 1
                                    ? "border-b-2 border-orange-500 transition duration-300"
                                      ...
                                      >
                                        ...
                                        <div class="-mx-2 mt-6 flex items-center">
                                          ...
                                          <button
                                            ...
                                            type="button"
                                            className="mx-2 transform rounded-lg bg-gray-300 p-2 text-sm font-medium text-gray-900 transition-colors duration-300 hover:bg-gray-200"
                                          >
                                            <span>
                                              {facebookLoading ? (
                                                "Loading"
