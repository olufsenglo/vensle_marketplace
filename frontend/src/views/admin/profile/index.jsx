...
setBusinessDetailsLoading(true)
  try {
    ...
    formData.append('business_address', businessDetails.business_address || '');
    ...
    formData.append('profile_picture', businessDetails.profile_picture || null);
	...
	dispatch({
	  type: SET_MESSAGE,
	  payload: {type: "success", message: "Business Details updated successfully!"},
	});
...
<>	
      <div className="w-ful mt-3 flex h-fit flex-col gap-5 lg:grid lg:grid-cols-12">
        <div className="col-span-6 lg:!mb-0 relative">
	
	{profileError && profileError?.profile_picture && 
		<div style={{zIndex: "5"}} className="absolute bg-white m-4 pt-4 bottom-0 right-0 left-0">
		{profileError.profile_picture.map((error, index)=>(<p key={index} style={{color:"red", fontSize: "13px"}} className="mb-1">{error}</p>))
		}
		</div>
        }
...
{console.log("rrre", profileError)}
		...
		profileError && profileError?.name ? "bg-red-50" : "bg-gray-50"
		    }`}
                  />
       {profileError && profileError?.name &&
                profileError.name.map((error, index)=>(<p key={index} style={{color:"red", fontSize: "13px"}} className="mt-1">{error}</p>))
        }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={userProfileChange}
                    className={`mt-2 block w-full rounded border-gray-300 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500 ${
		profileError && profileError?.email ? "bg-red-50" : "bg-gray-50"
		    }`}
                  />

	{profileError && profileError?.email &&
                profileError.email.map((error, index)=>(<p key={index} style={{color:"red", fontSize: "13px"}} className="mt-1">{error}</p>))
        }

                </div>

                <div class="relative">
                  <label for="phoneNumber" class="text-xs font-semibold text-gray-501">Phone number</label>
                  <input
                    type="text"
                    id="phoneNumber"
                    name="phone_number"
                    ...
                    onChange={userProfileChange}
                    className={`mt-2 block w-full rounded border-gray-300 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500 ${
		profileError && profileError?.phone_number ? "bg-red-50" : "bg-gray-50"
		    }`}
                  />

	{profileError && profileError?.phone_number &&
                profileError.phone_number.map((error, index)=>(<p key={index} style={{color:"red", fontSize: "13px"}} className="mt-1">{error}</p>))
        }
                </div>
                <div class="relative">
                  ...
                  <input
                    ...
                    className={`mt-2 block w-full rounded border-gray-300 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500 ${
		profileError && profileError?.address ? "bg-red-50" : "bg-gray-50"
		    }`}
                  />

	{profileError && profileError?.address &&
                profileError.address.map((error, index)=>(<p key={index} style={{color:"red", fontSize: "13px"}} className="mt-1">{error}</p>))
        }
...
{passwordError?.errorSummary && <p style={{color:"red", fontSize: "13px"}}>{passwordError.errorSummary}</p>}
                <div>
                  ...
                  <input
                    ...
                    className={`mt-2 block w-full rounded border-gray-300 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500 ${
		passwordError && passwordError?.old_password ? "bg-red-50" : "bg-gray-50"
		    }`}
                  />
       {passwordError && passwordError?.old_password &&
                passwordError.old_password.map((error, index)=>(<p key={index} style={{color:"red", fontSize: "13px"}} className="mt-1">{error}</p>))
        }
                </div>
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    onChange={passwordDataChange}
                    className={`mt-2 block w-full rounded border-gray-300 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500 ${
		passwordError && passwordError?.new_password ? "bg-red-50" : "bg-gray-50"
		    }`}
                  />
       {passwordError && passwordError?.new_password &&
                passwordError.new_password.map((error, index)=>(<p key={index} style={{color:"red", fontSize: "13px"}} className="mt-1">{error}</p>))
        }
                </div>
                <div class="relative">
                  ...
                  <input
                    ...
                    onChange={passwordDataChange}
                    className={`mt-2 block w-full rounded border-gray-300 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500 ${
		passwordError && passwordError?.new_password_confirmation ? "bg-red-50" : "bg-gray-50"
		    }`}
                  />
       {passwordError && passwordError?.new_password_confirmation &&
                passwordError.new_password_confirmation.map((error, index)=>(<p key={index} style={{color:"red", fontSize: "13px"}} className="mt-1">{error}</p>))
        }
...
{activeTab === 2 &&
        <form onSubmit={handleBusinessDetailsSubmit} className="w-ful mt-3 flex h-fit flex-col gap-5 lg:grid lg:grid-cols-12">
...
{businessDetailsError && <p style={{color:"red", fontSize: "13px"}} className="mb-1">{businessDetailsError}</p>}
	...
	<label htmlFor="profile_picture">Profile Picture:</label>
		...
		""
                ...
                <div>
                  <label for="businessName" class="text-xs font-semibold text-gray-500">Name</label>
                  <input
                    type="text"
                    id="businessName"
                ...
                <div>
                  <label for="businessEmail" class="text-xs font-semibold text-gray-500">Email</label>
                  <input
                    type="email"
                    id="businessEmail"
                    name="business_email"
		    ...
		    required
                ...
                <div class="relative">
                  <label for="phone" class="text-xs font-semibold text-gray-500">Phone number</label>
                  <input
                    type="text"
                    id="phone"
                    name="phone"
                ...
                <div class="relative">
                  <label for="businessAddress" class="text-xs font-semibold text-gray-500">Address</label>
                  <input
                    type="text"
                    id="businessAddress"
		...
		{certificatePreview && (
		  ...
		  />
	        ...
	        <div class="relative">
                  <label for="bankName" class="text-xs font-semibold text-gray-500">Bank Name:</label>
                  <input
                    type="text"
                    id="bankName"
                    name="bank_name"
	        ...
	        <div class="relative">
                  <label for="accountNumber" class="text-xs font-semibold text-gray-500">Account Number:</label>
                  <input
                    type="text"
                    id="accountNumber"
                    name="account_number"
         ...
         {businessDetailsLoading ? "Loading..." : "Update business details"}
                  </button>
                </div>
