  ...
  const handleShowSelectedImage = (image, index) => {
    return (
      <a
        ...
        href="#"
        class={`dark:border-transparent block border hover:border-blue-300 dark:hover:border-blue-300 ${
                        ...
                        <div class="w-full px-4">
                          <div class="sticky top-0 z-50 overflow-hidden ">
                            <div class="relative mb-6 lg:mb-10 lg:h-[28rem]">
                              <span onClick={handlePreviousPreviewImage}>
                                Prev
                              </span>
                              <img
                                style={{ width: "200rem" }}
                                src={previewImage}
                                alt=" /"
                                className="w-full object-cover lg:h-full lg:pl-[6rem] lg:pr-[6rem] "
                              />
                            ...
                            <div className="mx-auto px-8">
                              ...
                              <div className="flex items-center">
                                ...
                                <p className="text-sm leading-5 text-gray-600">
                                  <span className="text-gray-400">4.0</span> (16
                                  Feedbacks)
                                </p>
                              </div>
                              ...
                              <p className="mt-3 text-base leading-7 text-gray-600">
                                ...
                                blanditiis repellendus etur quidem dwelling.
                              </p>
