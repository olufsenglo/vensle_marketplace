...
<Header />
      ...
      <div className="mx-auto max-w-2xl px-4 py-4 sm:px-6 sm:py-8 lg:max-w-7xl lg:px-8">
            <div className="grid grid-cols-1 min-h-[30rem] gap-x-8 gap-y-10 lg:grid-cols-4">
...
<div className="mt-6 min-h-[10rem] relative grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
